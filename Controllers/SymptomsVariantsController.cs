...
namespace VirusAppFinal.Controllers
{
    public class SymptomsVariantsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VariantId,SymptomId,Cases")] SymptomsVariant symptomsVariant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VariantId,SymptomId,Cases")] SymptomsVariant symptomsVariant)
        {
